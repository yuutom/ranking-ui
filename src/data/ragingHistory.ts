...
import rawRatingHistory from './raging_history.json'


export const jsonRagingHistory: RatingRecord[] = rawRatingHistory.map(convertEnums)
...
export const latestRatings = (() => {
  ...
  for (const r of jsonRagingHistory as RatingRecord[]) {
